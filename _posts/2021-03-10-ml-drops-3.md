...
Dependendo da necessidade, é possível configurar o *Data Capture* para registrar o log de um percentual de todas as chamadas ao Sagemaker Endpoint, salvar apenas os dados da requisição ou da resposta do modelo. 
